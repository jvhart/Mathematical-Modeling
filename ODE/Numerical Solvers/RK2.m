...
% Description: This function implements Runge-Kutta's order 2 method to find a numerical solution to the specified initial value problem associated to a system of ODEs.  It returns a solution to the ode:
%	dY/dt=fh(t,Y); Y(a)=y0
