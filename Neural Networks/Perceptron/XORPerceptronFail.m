...
% this script is to demonstrate the failure of the Perceptron to classify
% data that is not linearly separable.  It generates an exclusive or
% problem (XOR) problem amonst 4 clusters, and attempts to train the
% Perceptron with poor results.
...
tic
W=TrainPerceptron(Data,eta,MaxEpoch);
toc
